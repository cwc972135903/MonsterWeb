 ...
 * @LastEditTime: 2020-11-04 17:46:01
-->  
<template>
  <div class="app-container">
    <el-dialog v-el-drag-dialog :close-on-click-modal="true" :visible.sync="visible" custom-class="editDialog-global" append-to-body @open="focusInput" @dragDialog="handleDrag">
  ...
  methods: {
    handleKeyDown: function (e) {
      ...
      if (key === 122) {//F11
        ...
        // if (this.selected) {
        //   this.$nextTick(()=>{ 
        //     this.$refs.headerGlobalSelect.focus();
        //   }); 
        // }
    ...
    focusInput() {
      this.$nextTick(() => {
        var that = this;
        setTimeout(function(){
          that.$refs.headerGlobalSelect.focus();
        },300);
      });
    },
    visibleChange(val){
    ...
    handleDrag() {
      this.$refs.headerGlobalSelect.blur();
    }
  }
}
</script>
