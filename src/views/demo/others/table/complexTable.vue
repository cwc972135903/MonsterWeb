<template>
  <div class="app-container" id="complexTableContainer" v-el-resize="{name:'contentSizeChange'}">
    <div class="filter-container">
     ...
     <Table-Header>
        <el-button size="mini" class="filter-item"  type="default" icon="el-icon-plus" @click="handleCreate">
          {{ $t('table.add') }}
        </el-button>
        <el-button size="mini" v-waves :loading="downloadLoading" class="filter-item" type="default" icon="el-icon-download" @click="handleDownload">
          {{ $t('table.export') }}
        </el-button> 
    </Table-Header> 
    <el-table 
